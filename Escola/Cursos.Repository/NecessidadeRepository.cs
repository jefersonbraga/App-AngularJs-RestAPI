...
{
      public partial class NecessidadeRepository : GenericRepository<EV_NECESSIDADE>, INecessidadeRepository
      {
			...
			public NecessidadeRepository(DbContext context) : base(context)
			{
				_context = context;
			}
      }
