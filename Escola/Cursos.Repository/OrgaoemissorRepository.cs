...
{
      public partial class OrgaoemissorRepository : GenericRepository<AD_ORGAOEMISSOR>, IOrgaoemissorRepository
      {
			...
			public OrgaoemissorRepository(DbContext context) : base(context)
			{
				_context = context;
			}
      }
