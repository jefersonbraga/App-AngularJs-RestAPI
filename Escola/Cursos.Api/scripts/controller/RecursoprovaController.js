...
///// </sumary>
"use strict";
app.controller("RecursoprovaController", ['$scope', 'RecursoprovaService', 'NotyService', function ($scope, RecursoprovaService, notyService) {
		$scope.tblData = [];
		$scope.Recursoprova = {};
        $scope.showModal = function (action) {
            ...
            $("#modal-Recursoprova").removeClass().addClass("modal bounceInRight animated active");
            $(".header").removeClass("active");
            $(".modal").data("action", action);
        }

		$scope.exitModal = function () {
			$("#modal-Recursoprova").removeClass().addClass("modal bounceOut animated");
		...
		$scope.Columns = [
        				{ field: "Id", title: "Id", sortable: false, visible:false },
							...
							{ field: "Hrinicio", title: "Hrinicio", sortable: true },
